classdef TransformerDecoderLayer < nnet.layer.Layer
    properties
        NumHeads
        EmbedDim
        NumTransformers
    ...
    methods
        function obj = TransformerDecoderLayer(numHeads, embedDim, numTransformers, intermediateDim, dropoutRate, name)
        ...
        function Z = predict(obj, X)
            ...
            % Concatenate heads
            attentionOutput = reshape(attentionOutput, size(attentionOutput, 1), obj.EmbedDim);
